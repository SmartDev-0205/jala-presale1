                ...
                <div className="w-full">
                    ...
                    <div className="flex justify-between items-end">
                        ...
                        <div className="flex gap-2">
                            <a href="YOUR_DISCORD_URL" target="_blank" rel="noopener noreferrer">
                                <img
                                    src={discordImg}
                    ...
                    <p className="text-white text-base py-4 text-justify">
                        44444 (JALA) blends the vibrancy of meme culture with the universal appeal of casual dining, creating a unique space in the cryptocurrency world. Aimed at fostering a community that values humor and simplicity, JALA bridges the gap between digital entertainment and the tangible pleasure of enjoying street food and local culinary gems.
                    </p>
                </div>
            </div>
        </section>
